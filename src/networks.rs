...
impl Asset {
    ...
    pub fn router(&self) -> Option<Addresses> {
        if self == &Asset::Ethereum {
            return Some(Addresses {
                local: "0xdbd4910f54a3751f964cb3bad99374134b2e34e7".to_string(),
                devnet: "".to_string(),
    ...
    pub fn multisig(&self) -> Option<Addresses> {
        if self == &Asset::Ethereum {
            return Some(Addresses {
                local: "0xeed55a8e858d98371330d990358360ee36eeee6f".to_string(),
                devnet: "".to_string(),
    ...
    pub fn address(&self) -> Option<Addresses> {
        match self {
            ...
            Asset::Tether => Some(Addresses {
                local: "0x348484e4a9a95dbd667398fe4f4fa6d4aaae4e18".to_string(),
                devnet: "".to_string(),
